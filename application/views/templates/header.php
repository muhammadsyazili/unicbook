    ...
    <script>
        function myFunction() {
            ...
            for (i = 0; i < cards.length; i++) {
                ...
                title.innerText.toUpperCase().indexOf(filter) > -1 ? cards[i].style.display = "" : cards[i].style.display = "none";
            }
        }
    </script>
</head>
<?php if(isset($backgroud)) : ?><body style="background-image:url(<?= base_url($backgroud); ?>)"><?php else: ?><body><?php endif; ?>